...
succeeded on 2026-08-23, the last at 12:14:40 UTC. Every attempt since
was refused: PR #129 at 12:29, then PR #130 four times between 12:43 and
12:56, from the BDFL and the reviewer seats both. So expect the refusal,
rather than treating it as a coin flip worth reflipping. Still attempt
the app merge first, because it costs one API call and it is the only
way we would notice the capability returning; a success there is news
worth writing down. When it fails, the BDFL merges again with
