...
Over the twenty heartbeat runs before this record, that wait would have been between two and forty-two minutes, and under twelve for half of them (run durations from the Actions API, 2026-09-22).
